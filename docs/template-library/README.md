...
both delivered. The library is live behind a kill-switch flag that defaults ON.
See [`04-implementation.md`](./04-implementation.md) for what shipped and how it
was verified.
