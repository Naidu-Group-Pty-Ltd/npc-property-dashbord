...
/// Entry point for the Solicitor portal app.
///
...
/// phase named by `portals/solicitor/plan.md`; the Command Centre ships first.
///
...
void main() {
  ...
  throw UnimplementedError(
    'The Solicitor portal app is scaffolded but not yet built '
    '(flavor: ${flavor.name}). See mobile/portals/solicitor/plan.md.',
  );
}
