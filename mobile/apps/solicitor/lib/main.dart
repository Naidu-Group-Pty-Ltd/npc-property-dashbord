...
/// NPC Solicitor Portal — its own app (`mobile/plan.md` R-ARCH-1).
///
...
///
/// If `NpcPortals.solicitor` reports blockers, the shell shows them rather than
/// pretending to work — see `PortalUnavailableScreen`.
void main() => bootstrapPortal(
  descriptor: NpcPortals.solicitor,
  home: (_) => const SolicitorHomeScreen(),
);
