...
/// Entry point for the Builder portal app.
///
...
/// phase named by `portals/builder/plan.md`; the Command Centre ships first.
///
...
void main() {
  ...
  throw UnimplementedError(
    'The Builder portal app is scaffolded but not yet built '
    '(flavor: ${flavor.name}). See mobile/portals/builder/plan.md.',
  );
}
