...
android {
    namespace = "au.com.npcservices.npc_finance"
    ...
    defaultConfig {
        ...
        applicationId = "au.com.npcservices.npc_finance"
    ...
    productFlavors {
        create("development") {
            ...
            resValue("string", "app_name", "NPC Finance Dev")
        }
        create("staging") {
            dimension = "environment"
            applicationIdSuffix = ".staging"
            versionNameSuffix = "-staging"
            resValue("string", "app_name", "NPC Finance Staging")
        }
        create("production") {
            dimension = "environment"
            resValue("string", "app_name", "NPC Finance")
        }
    }
