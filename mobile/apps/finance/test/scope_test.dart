...
void main() {
  const NpcPortalDescriptor descriptor = NpcPortals.finance;

  test('the finance app is portal-scoped and cannot reach staff functions', () {
  ...
  test('its login function name matches the backend', () {
    expect(descriptor.loginFunction, 'finance-portal-login');
  });
}
