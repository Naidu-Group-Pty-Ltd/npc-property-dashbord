...
/// Entry point for the Finance portal app.
///
...
/// phase named by `portals/finance/plan.md`; the Command Centre ships first.
///
...
void main() {
  ...
  throw UnimplementedError(
    'The Finance portal app is scaffolded but not yet built '
    '(flavor: ${flavor.name}). See mobile/portals/finance/plan.md.',
  );
}
