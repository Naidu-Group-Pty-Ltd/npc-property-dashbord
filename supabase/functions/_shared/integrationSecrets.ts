...
export const ALLOWED_INTEGRATION_SECRETS = new Set<string>([
  ...
  'GOOGLE_DISTANCE_MATRIX_DAILY_LIMIT',
  ...
  'GOOGLE_MAPS_API_KEY',
  'GOOGLE_PLACES_AUTOCOMPLETE_DAILY_LIMIT',
  'GOOGLE_PLACES_DAILY_LIMIT',
  'GOOGLE_PLACES_NEARBY_DAILY_LIMIT',
  'GOOGLE_STATIC_MAPS_DAILY_LIMIT',
  ...
  'OPENAI_API_KEY',
  'OPENROUTER_API_KEY',
  'OSM_AUTOCOMPLETE_DAILY_LIMIT',
  'OSM_GEOCODING_DAILY_LIMIT',
  'PADDLE_API_KEY',
...
export const INTEGRATION_SECRET_MAP: Record<string, string[]> = {
  ...
  'google': ['GOOGLE_MAPS_API_KEY', 'GOOGLE_GEOCODING_DAILY_LIMIT', 'GOOGLE_PLACES_NEARBY_DAILY_LIMIT', 'GOOGLE_PLACES_AUTOCOMPLETE_DAILY_LIMIT', 'GOOGLE_DISTANCE_MATRIX_DAILY_LIMIT', 'GOOGLE_STREET_VIEW_DAILY_LIMIT', 'GOOGLE_STATIC_MAPS_DAILY_LIMIT', 'GOOGLE_PLACES_DAILY_LIMIT'],
  'openstreetmap': ['GEOCODER_PROVIDERS', 'OSM_GEOCODING_DAILY_LIMIT', 'GEOCODER_OSM_URL', 'ADDRESS_AUTOCOMPLETE_PROVIDER', 'OSM_AUTOCOMPLETE_DAILY_LIMIT', 'AUTOCOMPLETE_PHOTON_URL'],
