...
const navigationItems = [
  ...
  { title: 'Loan Writer Undertakings', url: '/loan-writer-undertakings', icon: FileSignature, moduleKey: 'agreements' },
  { title: 'Partner Compliance', url: '/partner-compliance', icon: ShieldCheck, moduleKey: 'agreements' },
...
const adminItems = [
  ...
  { title: 'Solicitor Portal', url: '/admin/solicitor-portal', icon: Scale, moduleKey: 'solicitor_portal_admin' },
  { title: 'Builder / Developer Portal', url: '/admin/builder-portal', icon: HardHat, moduleKey: 'builder_portal_admin' },
