...
import { PREMIUM_PDF_DESIGN_CONTROLS_VISIBLE } from '@/components/reports/premiumPdfDesignVisibility';
      ...
      <Collapsible open={controlsOpen} onOpenChange={setControlsOpen}>
        <Card className="overflow-hidden border-primary/10 bg-card/95 shadow-sm">
          ...
          {/* The Design section is hidden product-wide — see
              `premiumPdfDesignVisibility.ts`. The heading, the description and
          ...
          {PREMIUM_PDF_DESIGN_CONTROLS_VISIBLE && (
