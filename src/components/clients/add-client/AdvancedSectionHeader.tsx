...
export const premiumSectionClass = 'overflow-hidden rounded-3xl border border-border/70 bg-gradient-to-br from-card via-card to-muted/20 shadow-lg shadow-foreground/5';
