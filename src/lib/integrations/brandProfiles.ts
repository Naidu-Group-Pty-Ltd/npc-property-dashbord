...
export const BRAND_PROFILES: Record<string, BrandProfile> = {
  ...
  assemblyai: { color: '2545F6', luminance: 'dark' },
  voyage: { color: '2563EB', luminance: 'dark' },
  pinecone: { slug: 'pinecone', color: '000000', luminance: 'dark' },
  ...
  postmark: { color: 'FFDE00', luminance: 'dark' },
  ...
  adobe_pdf: { slug: 'adobeacrobatreader', color: 'EC1C24', luminance: 'dark' },
  pandadoc: { slug: 'pandadoc', color: '4CAF50', luminance: 'dark' },
  ...
  myob: { color: '6100A5', luminance: 'dark' },
  ...
  mixpanel: { color: '7856FF', luminance: 'dark' },
  ...
  microsoft_teams: { slug: 'microsoftteams', color: '6264A7', luminance: 'dark' },
  ...
  onedrive: { slug: 'microsoftonedrive', color: '0078D4', luminance: 'dark' },
  ...
  apify: { slug: 'apify', color: 'FF9013', luminance: 'dark' },
  ...
  aws: { slug: 'amazonwebservices', color: 'FF9900', luminance: 'dark' },
  ...
  doppler: { slug: 'doppler', color: '3391FF', luminance: 'dark' },
