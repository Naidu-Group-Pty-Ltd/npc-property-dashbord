  ...
  public: {
    Tables: {
      ...
      internal_message_threads: {
        ...
        Relationships: [
          {
            foreignKeyName: "internal_message_threads_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "custom_users"
            referencedColumns: ["id"]
      ...
      internal_thread_participants: {
        ...
        Relationships: [
          {
            foreignKeyName: "internal_thread_participants_thread_id_fkey"
            columns: ["thread_id"]
            isOneToOne: false
            referencedRelation: "internal_message_threads"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "internal_thread_participants_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "custom_users"
            referencedColumns: ["id"]
      ...
      market_source_reconciliation_audits: {
        Row: {
          archived_rows: number
          canonical_count: number
          completed_at: string | null
          disabled_canonical_count: number
          enabled_canonical_count: number
          fetch_run_references_reassigned: number
          id: string
          matched_legacy_rows: number
          merged_rows: number
          metadata: Json
          ...
          update_references_reassigned: number
        }
        Insert: {
          archived_rows?: number
          canonical_count?: number
      ...
      market_sources: {
        ...
        Relationships: [
          {
            foreignKeyName: "market_sources_superseded_by_source_id_fkey"
      ...
      market_updates_automation_runs: {
        Row: {
          correlation_id: string | null
      ...
      market_updates_operational_alerts: {
        Row: {
          alert_key: string
      ...
      template_library_entries: {
        ...
        Relationships: [
          {
            foreignKeyName: "template_library_entries_source_template_id_fkey"
      ...
      template_library_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "template_library_events_entry_id_fkey"
            columns: ["entry_id"]
            isOneToOne: false
            referencedRelation: "template_library_entries"
            referencedColumns: ["id"]
          },
        ]
      }
      template_library_instantiations: {
        Row: {
          created_at: string
          created_by_user_id: string | null
          entry_id: string
          entry_version_at_copy: number
          id: string
          template_id: string | null
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "template_library_instantiations_entry_id_fkey"
            columns: ["entry_id"]
            isOneToOne: false
            referencedRelation: "template_library_entries"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "template_library_instantiations_template_id_fkey"
            columns: ["template_id"]
            isOneToOne: false
            referencedRelation: "report_templates"
            referencedColumns: ["id"]
